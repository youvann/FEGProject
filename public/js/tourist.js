(function() {
  ...
  */
  ...
  Tourist.Tip.Base = (function() {
    ...
    Base.prototype.skipButtonTemplate = '<button class="btn btn-default btn-sm pull-right tour-next">Passer →</button>';
    ...
    */
    ...
    Base.prototype._buildContentElement = function(step) {
      ...
      content = $($.parseHTML(this.template({
        ...
        counter: step.final ? '' : "Etapes " + (step.index + 1) + " sur " + step.total,
