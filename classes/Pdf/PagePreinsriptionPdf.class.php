...
/**
 * @Project: FEG Project
 * @File   : /classes/Pdf/PagePreinscriptionPdf.class.php
...
class PagePreinscriptionPdf {
    ...
    //cette fonction est utilisée dans la fonction getPartieAdministration()
    public function getAdequationCompetence(){
        return '
             <div>
