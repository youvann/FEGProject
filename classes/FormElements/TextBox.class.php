...
class TextBox extends FormElement {
	...
	public function __toString() {
		return $this->getLabel() . '<input class="form-control" data-validation="custom" data-validation-optional="true" data-validation-regexp="^([0-9a-zA-Z/\-\'\séêèëààâäôœöûüùîïç]+)$" data-validation-error-msg="Un champ relatif aux informations spécifiques n\'a pas été rempli" type="text" id="' . $this->id . '" name="' . $this->name . '" value="' . $this->value . '" />';
	}
